  ...
  void initState() {
    ...
    _webViewController = WebViewController()
      ..loadRequest(Uri.parse(
          "${Config.paymentBaseUrl}result.php?detail=Movers&amount=${widget.totalAmount}&order_id=${UniqueKey().hashCode}&name=${widget.name}&email=${widget.email}&phone=${widget.phon}"))
